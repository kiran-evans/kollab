...
router.route('/')
    .post((0, express_validator_1.body)('idToken').notEmpty().isJWT(), (0, express_validator_1.body)('title').notEmpty().isAlphanumeric(), (0, express_validator_1.body)('message').notEmpty().isAlphanumeric(), (0, express_validator_1.body)('tools').notEmpty().isArray(), (0, express_validator_1.body)('difficulty').notEmpty(), postController_1.createPost)
